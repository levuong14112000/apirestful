...
export class UpdateComponent {
  ...
  constructor(private shopSevice : ShopService,private fb: FormBuilder,private activatedRoute : ActivatedRoute, private router: Router) {
  ...
  onSubmit() {
    ...
    this.shopSevice.updateProduct(id,formData).subscribe({
      next: () => {
